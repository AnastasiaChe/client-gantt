...
INSERT INTO projects (client_id, name, status, starts_on, ends_on, notes) VALUES
(1, 'Website redesign', 'in_progress', CURRENT_DATE, DATE_ADD(CURRENT_DATE, INTERVAL 28 DAY), 'Demo project.');
...
INSERT INTO tasks (stage_id, name, status, starts_on, ends_on, estimated_hours, crm_url, description, sort_order) VALUES
(1, 'Collect source materials', 'done', CURRENT_DATE, DATE_ADD(CURRENT_DATE, INTERVAL 2 DAY), 4, NULL, 'Brief, analytics, competitors.', 10),
(1, 'Map conversion leaks', 'in_progress', DATE_ADD(CURRENT_DATE, INTERVAL 2 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 7 DAY), 12, NULL, 'Find what blocks leads.', 20),
(2, 'Homepage draft', 'planned', DATE_ADD(CURRENT_DATE, INTERVAL 8 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 13 DAY), 18, NULL, 'First compact draft.', 10);
